...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.all.where(title: "Title", release_date: "2000", director: "Me")
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by 
  # release date descending
  testVar = Movie.where("release_date > 2002")
  return testVar.order("release_date DESC")
end
...
def can_update_using_update_method
  ...
  moobie = Movie.find_by(title: 'Wat?')
  moobie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  moobie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  moobie.destroy
end
